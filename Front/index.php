...
<html>
	...
	<body>
		<div class="flex-grid">
			<div class="row" style="height: 47.5vh; width: 200vh;">
				<div class="cell colspan6 bg-blue" style="width: 100%; height: 100%;"><!-- autobuffer autoloop loop autoplay  -->
					<video class="" style="min-width: 100%; min-height: 100%;">
						<source src="../media/video/asds.mp4">
						<source src="../media/video/asd.m4v">
					</video>
				</div>
				<div class="cell colspan6 bg-lighterBlue" style="width: 100%; height: 100%;">
					Box 2
				</div>
			</div>
			<div class="row" style="height: 47.5vh; width: 200vh;" style="width: 100%; height: 100%;">
				<div class="cell colspan6 bg-green">
					Box 3
				</div>
				<div class="cell colspan6 bg-lightGreen" style="width: 100%; height: 100%;">
					Box 4
				</div>
			</div>
